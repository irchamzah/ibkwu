        ...
        if( 0 == $profitmag_settings['profitmag_fbxone_setting'] && 
            ...
            <div class="home-featured-block">
                ...
                $args = array(
                    ...
                    'text'  => esc_html__( 'You are viewing this message because options of home page have not been setup.<br/> Please go to "Appearance >> Customize >> Theme Options >> Home Page Blocks" in admin panel to setup options.', 'profitmag' ),
                    );
                $widget_args = array(
