...
class WP_ProfitMag_Popular_Posts extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array('classname' => 'profitmag_widget_popular_entries', 'description' => esc_html__( "Display most popular posts with thumbnail and date of post.", 'profitmag') );
		parent::__construct('profitmag-popular-posts', esc_html__('Profitmag: Popular Posts', 'profitmag'), $widget_ops);
	...
	public function widget($args, $instance) {		
		...
		$title = ( ! empty( $instance['title'] ) ) ? $instance['title'] : esc_html__( 'Popular', 'profitmag' );
